...
data cleaning.
```{r}
pacman::p_load(tidyverse, lme4, ggrepel, paletteer, vip, kableExtra, performance, gt)
...
genes |> 
  ...
  facet_wrap(~ cell_type, scales="free",
             labeller = labeller(cell_type = c("101 Type", "Wild Type"))) +
...
To demonstrate the fit of our model to our data, we plot the regression against the data points, separating by cell type for clarity, shown in Figure @fig-m2fit:
```{r}
#| label: fig-m2fit
